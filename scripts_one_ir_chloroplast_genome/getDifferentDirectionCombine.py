    ...
    for lscDirection in lscs:
        for sscDirection in sscs:
            for irDirectionA in irs:
                    genomes[lscDirection + irDirectionA + sscDirection]      = lscs[lscDirection] + irs[irDirectionA] + sscs[sscDirection] + lscs[lscDirection]
                    genomes_ori[lscDirection + irDirectionA + sscDirection]  = lscs[lscDirection] + irs[irDirectionA] + sscs[sscDirection] 
